...
using mc.MultiTenancy.HostDashboard;
...
namespace mc.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(mcDbContext context, SubscriptionPayment subscriptionPayment)
        {

...
{
    public class SubscriptionPaymentRepository : mcRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<mcDbContext> dbContextProvider)

...
using mc.EntityFrameworkCore.Repositories;

namespace mc.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : mcRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<mcDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }

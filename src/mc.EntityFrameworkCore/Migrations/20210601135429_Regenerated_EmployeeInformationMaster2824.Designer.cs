...
namespace mc.Migrations
{
    ...
    [Migration("20210601135429_Regenerated_EmployeeInformationMaster2824")]
    partial class Regenerated_EmployeeInformationMaster2824
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mc.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("mc.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("mc.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("mc.Authorization.Users.User", null)
                        .WithMany("Claims")

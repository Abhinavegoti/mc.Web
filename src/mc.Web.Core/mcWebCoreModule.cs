...
using mc.Startup;
using mc.Web.Authentication.JwtBearer;
using mc.Web.Authentication.TwoFactor;
using mc.Web.Chat.SignalR;
using mc.Web.Configuration;
using mc.Web.DashboardCustomization;

namespace mc.Web
{
    [DependsOn(
        typeof(mcApplicationModule),
        typeof(mcEntityFrameworkCoreModule),
    ...
    public class mcWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public mcWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(mcApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(mcWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(mcWebCoreModule).Assembly);
        }

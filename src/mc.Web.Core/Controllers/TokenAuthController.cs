...
using mc.Authentication.TwoFactor.Google;
...
using mc.Web.Models.TokenAuth;
using mc.Authorization.Impersonation;
...
using mc.Web.Authentication.External;
using mc.Web.Common;
...
namespace mc.Web.Controllers
{
    ...
    public class TokenAuthController : mcControllerBase
    {

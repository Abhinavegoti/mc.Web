...
export class AppNavigationService {
    ...
    getMenu(): AppMenu {
        return new AppMenu('MainMenu', 'MainMenu', [
            ...
            new AppMenuItem('HRM', '', 'flaticon-users', '', [], [
                new AppMenuItem('Masters', '', 'flaticon-interface-8', '', [], [
                    new AppMenuItem('Employee Information', 'Pages.EmployeeInformationMasters', 'flaticon-more', '/app/main/employeeInformationMasters/employeeInformationMasters'),
                    new AppMenuItem('Departments', 'Pages.Departments', 'flaticon-more', '/app/main/departments/departments'),
                    new AppMenuItem('SubDepartments', 'Pages.SubDepartments', 'flaticon-more', '/app/main/subDepartments/subDepartments'),
            ]),
        ]),

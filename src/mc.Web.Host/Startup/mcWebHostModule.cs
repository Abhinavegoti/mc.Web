...
using mc.Web.Startup.ExternalLoginInfoProviders;
...
namespace mc.Web.Startup
{
    ...
    public class mcWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public mcWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(mcWebHostModule).GetAssembly());
        }

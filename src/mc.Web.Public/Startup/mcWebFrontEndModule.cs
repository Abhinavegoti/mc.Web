...
namespace mc.Web.Public.Startup
{
    [DependsOn(
        typeof(mcWebCoreModule)
    )]
    public class mcWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public mcWebFrontEndModule(IWebHostEnvironment env, mcEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(mcWebFrontEndModule).GetAssembly());
        }
    }
}

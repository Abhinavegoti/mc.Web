...
namespace mc.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : mcServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("mc", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);

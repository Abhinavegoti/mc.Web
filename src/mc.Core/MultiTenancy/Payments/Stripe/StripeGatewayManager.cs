...
namespace mc.MultiTenancy.Payments.Stripe
{
    public class StripeGatewayManager : mcServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "mc";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + mcConsts.Currency;
        }

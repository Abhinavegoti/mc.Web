...
using mc.Authorization.Ldap;
using mc.Authorization.Roles;
using mc.Authorization.Users;
using mc.Chat;
using mc.Configuration;
using mc.DashboardCustomization.Definitions;
using mc.Debugging;
using mc.DynamicEntityProperties;
using mc.Features;
using mc.Friendships;
using mc.Friendships.Cache;
using mc.Localization;
using mc.MultiTenancy;
using mc.Net.Emailing;
...
{
    [DependsOn(
        typeof(mcCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class mcCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            mcLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = mcConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, mcMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<mcSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(mcCoreModule).GetAssembly());
        }

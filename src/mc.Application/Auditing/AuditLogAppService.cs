...
using mc.Auditing.Exporting;
using mc.Authorization;
using mc.Authorization.Users;
using mc.Dto;
using mc.EntityHistory;
using EntityHistoryHelper = mc.EntityHistory.EntityHistoryHelper;

namespace mc.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : mcAppServiceBase, IAuditLogAppService
    {

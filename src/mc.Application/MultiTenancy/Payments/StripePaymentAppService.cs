...
using mc.MultiTenancy.Payments.Stripe;
using mc.MultiTenancy.Payments.Stripe.Dto;
using Stripe;
using Stripe.Checkout;

namespace mc.MultiTenancy.Payments
{
    public class StripePaymentAppService : mcAppServiceBase, IStripePaymentAppService
    {

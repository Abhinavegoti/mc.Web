...
using mc.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace mc.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : mcAppServiceBase, IDashboardCustomizationAppService
    {

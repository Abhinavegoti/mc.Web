...
{
    public class SessionAppService : mcAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = mcConsts.Currency,
                    CurrencySign = mcConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = mcConsts.AllowTenantsToChangeEmailSettings,

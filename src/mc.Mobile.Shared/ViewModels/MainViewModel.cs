...
using mc.Commands;
using mc.Core.Threading;
using mc.Models.NavigationMenu;
using mc.Services.Navigation;
using mc.ViewModels.Base;
using Plugin.Media;
...
using mc.UI.Assets;
using mc.Views;
using DependencyResolver = mc.Core.Dependency.DependencyResolver;
...
namespace mc.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "mc";
